...
namespace backend.Controllers
{
    ...
    public class Form8Controller : ControllerBase
    {
        ...
        // POST /form8/add
        [HttpPost("add")]
        public async Task<IActionResult> Add([FromBody] Form8Dto dto)
        {
            ...
            var record = new Form8_2025
            {
                ...
                Unavailable_Minutes_Id = Guid.NewGuid().ToString("N"),
                Total_Minutes_Id = Guid.NewGuid().ToString("N"),
                Total_Nodes_Id = Guid.NewGuid().ToString("N"),
        ...
        // PUT /form8/update/{id}
        [HttpPut("update/{id}")]
        public async Task<IActionResult> Update(string id, [FromBody] Form8Dto dto)
        {
            if (dto == null) return BadRequest("Invalid payload");
