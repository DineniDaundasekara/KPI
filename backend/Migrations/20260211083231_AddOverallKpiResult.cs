...
{
    /// <inheritdoc />
    public partial class AddOverallKpiResult : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    kpi_code = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    achieved = table.Column<decimal>(type: "decimal(18,5)", nullable: false),
                    points_applicable = table.Column<int>(type: "int", nullable: false),
                    points_achieved = table.Column<decimal>(type: "decimal(18,5)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    username = table.Column<short>(type: "smallint", nullable: true),
                    name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    role = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    isActive = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    pages_0 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    pages_1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    pages_2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    pages_3 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    pages_4 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    pages_5 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    pages_6 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    pages_7 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    pages_8 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    createdAt = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    updatedAt = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    v = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "UQ_OverallKpiResult_Key",
                schema: "dbo",
                table: "OverallKpiResult",
                columns: new[] { "kpi_code", "area_code", "year", "month" },
                unique: true);
